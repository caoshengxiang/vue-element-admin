  ...
  temRoute = [
    ...
    },
    {
      ...
      children: [{
        ...
        path: 'uploadList',
        name: 'electronic-license-uploadList',
        component: () => import('@/views/electronic-license/uploadList/index'),
        meta: { title: '批量上传记录', icon: 'example' },
        hidden: true
      }, {
        path: 'check-index',
        name: 'check-index',
...
export const constantRoutes = temRoute
