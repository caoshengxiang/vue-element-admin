...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getList2() {
        this.$api.statistics.taskStatics(Object.assign({}, this.searchForm, { interfaceType: 2 })).then(da => {
          if (da.data.outData) {
            const names = []
            this.options2.xAxis.data = da.data.outData
            this.options2.series = da.data.value.map((item, index) => {
              names.push(item.name)
              return {
                name: item.name,
                type: 'line',
            ...
            this.options2.legend.data = names
          } else {
      ...
      getList3() {
        this.$api.statistics.taskStatics(Object.assign({}, this.searchForm, { interfaceType: 3 })).then(da => {
          if (da.data.outData) {
            const names = []
            this.options3.xAxis.data = da.data.outData
            this.options3.series = da.data.value.map((item, index) => {
              names.push(item.name)
              return {
                name: item.name,
                type: 'line',
            ...
            this.options3.legend.data = names
          } else {
